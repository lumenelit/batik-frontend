      ...
      <header className='flex items-center justify-between py-3 mb-3'>
        <Popup
          ...
          <div className='flex flex-col items-center justify-center p-3 mx-3 transition-all bg-white rounded-xl'>
            <LazyLoadImage src={SignOutImg} alt='' height={180} effect='blur' />
            <h2 className='text-2xl font-bold text-center'>
              {t('navigation.modalTitle')}
            </h2>
            <p className='mb-8 font-semibold text-center'>
              {t('navigation.modalDescription')}
            </p>
        ...
        <Popup
          ...
          <div className='relative flex flex-col items-center justify-center transition-all bg-white p-7 rounded-xl w-72'>
            ...
            <button
              ...
              className='px-8 py-2 font-bold transition-all rounded-lg text-white bg-danger hover:opacity-75'>
              {t('navigation.modalButton')}
            </button>
          </div>
        </Popup>
        <span className='text-xl font-bold'>{t('navigation.title')}</span>
        <button
          type='button'
      ...
      <div className='w-full py-[8px] px-[15px] flex justify-between items-center border-b border-stroke mb-3'>
        ...
        <div
          ...
          <button
            ...
            className='w-full h-full transition-all rounded-full bg-white hover:bg-disabled'>
        ...
        <div
          ...
          <h1 className='font-bold text-[20px] text-[#2D2D2D] '>{label}</h1>
        </div>
        <button
          type='button'
          onClick={() => setProfile(true)}
